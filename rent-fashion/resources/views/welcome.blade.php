            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="toggler">
                        <a class="navbar-brand" href="#"><span style="color: C;">FASHION</span>.ID</a>
                        ...
                        <div class="button-container">
                            <a href="{{ route('login') }}" class="btn btn-outline-dark custom-button">LOGIN</a>
                            <a href="#" class="btn btn-primary custom-button">REGISTER</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-style">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title costume-card-tittle">FashionFusion</h5>
                        ...
                        <div class="col-md-4">
                            <div class="card card-style">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title costume-card-tittle">StyleShare</h5>
                        ...
                        <div class="col-md-4">
                            <div class="card card-style">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title costume-card-tittle">Rent-a-Chic</h5>
    ...
    <section id="footer-web" class="footer-web">
        <footer class="text-center text-lg-start costume-footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h1 class="custome-big-footer">WAD 2023</h1>
                    </div>
                    <div class="col-md-3 ms-md-auto">
                        <h5 class="custome-small-footer">
                            Nama : Aebil Taskari Rusydi <br>
                            NIM : 1202204126 <br>
                            Kode Asprak : ASKA
                        </h5>
                    </div>
