...
<div>
    ...
    <div class="mt-5 w-50">
        ...
        <form action="/fashion-edit/{{ $fashion->slug }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @if ($fashion->cover != '')
                <img src="{{ asset('storage/cover/' . $fashion->cover) }}" alt="Cover Image"
            ...
            <div class="mb-3">
                ...
                <p>
                    @foreach ($fashion->categories as $category)
                    | {{ $category->name }} |
                    @endforeach
                </p>
